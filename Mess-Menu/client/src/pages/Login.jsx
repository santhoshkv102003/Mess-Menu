...
const Login = () => {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark min-h-screen overflow-y-auto transition-colors duration-300 font-display py-4 md:py-0 md:flex md:items-center md:justify-center">
            {/* Dark Mode Toggle */}
            <button
                className="fixed top-4 right-4 md:top-6 md:right-6 p-2 rounded-full bg-white dark:bg-slate-800 shadow-md text-slate-600 dark:text-slate-300 hover:scale-110 transition-all z-50"
            ...
            <main className="w-full max-w-[1100px] flex flex-col md:flex-row shadow-2xl rounded-3xl overflow-hidden m-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 mx-auto">
                {/* Left Side - Image/Hero - Reduced Height on Mobile */}
                <div className="relative w-full md:w-1/2 h-40 md:h-auto overflow-hidden bg-slate-200 dark:bg-slate-800">
                    <img
                ...
                {/* Right Side - Form - Optimized Padding for Mobile */}
                <div className="w-full md:w-1/2 p-6 pb-8 md:p-12 lg:p-16 flex flex-col justify-center bg-white dark:bg-slate-900 transition-colors">
                    <div className="max-w-md mx-auto w-full">
                        <div className="mb-8 md:mb-10">
                            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-2">Welcome back</h2>
                        ...
                        {/* Enhanced Register Link Section for Mobile Visibility */}
                        <div className="mt-8 md:mt-10 p-4 md:p-0 bg-slate-50 dark:bg-slate-800/50 md:bg-transparent rounded-2xl flex flex-col items-center justify-center gap-2">
                            <span className="text-slate-600 dark:text-slate-400 text-base">New Student?</span>
                            <Link className="font-bold text-primary hover:underline underline-offset-4 text-lg flex items-center gap-1" to="/register">
                                Create Account
                                <span className="material-icons-round text-xl">person_add</span>
                            </Link>
                        </div>
                        <div className="mt-8 md:mt-12 flex flex-wrap items-center justify-center gap-4 md:gap-6 text-xs text-slate-400 dark:text-slate-600 font-medium">
